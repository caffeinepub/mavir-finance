...
export class Backend implements backendInterface {
    ...
    async divide(arg0: bigint, arg1: bigint): Promise<bigint | null> {
        if (this.processError) {
            try {
    ...
    async multiply(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async subtract(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
